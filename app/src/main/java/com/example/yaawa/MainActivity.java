            ...
            if (temp.isEmpty()) {
                ...
                if (lenTemp == 608|lenTemp == 411|lenTemp == 6081998|lenTemp == 60898|
                    ...
                    //0
                        ...
                        layla = "מה 0, אין מצב שהמצב רוח שלך הוא 0, נתי לי לשמח אותך בשיר : בכל יום אתה פוגש חבר, דומה לך בקצת אחר , כל אחד הוא מיוחד, אז שים לב היי היי איזה יום נפלא היום, לשחק וגם לחלום, יום נפלא להיות עם מצב רוח טוב (ולא 0) - כתבתי לבד נודר";
